...
void test_01_project_write_read_roundtrip_v32() {
        uint8_t buf[16384];
        ...
        TEST_ASSERT_TRUE((int(ld.waveform())) == (int(l.waveform())));
        TEST_ASSERT_TRUE((int(ld.mode())) == (int(l.mode())));
        TEST_ASSERT_TRUE((ld.clip()) == (l.clip()));
        TEST_ASSERT_TRUE((ld.hi()) == (int(l.hi())));
        TEST_ASSERT_TRUE((ld.low()) == (int(l.low())));
        TEST_ASSERT_TRUE((ld.speed()) == (int(l.speed())));
        TEST_ASSERT_TRUE((ld.freeFreqCentihz()) == (int(l.freeFreqCentihz())));
        TEST_ASSERT_TRUE((ld.pulseWidth()) == (int(l.pulseWidth())));
        TEST_ASSERT_TRUE((ld.nudge()) == (int(l.nudge())));
...
int main() {
    UNITY_BEGIN();
    RUN_TEST(test_01_project_write_read_roundtrip_v32);
    return UNITY_END();
}
