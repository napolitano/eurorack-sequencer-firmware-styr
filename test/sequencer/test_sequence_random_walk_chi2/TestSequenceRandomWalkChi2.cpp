...
void test_01_per_state_randomwalk_next_step_distribution_matches_50_50_via_z_test() {
        const int first = 0;
...
int main() {
    UNITY_BEGIN();
    RUN_TEST(test_01_per_state_randomwalk_next_step_distribution_matches_50_50_via_z_test);
    return UNITY_END();
}
