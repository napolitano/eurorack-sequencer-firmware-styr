...
![Build Status](https://github.com/napolitano/performer-nx/actions/workflows/ci.yml/badge.svg?branch=master)

# PERFORMER NX

<a href="doc/sequencer.jpg"><img src="doc/sequencer.jpg"/></a>

<!-- Prominent development status badge + warning -->
[![UNDER DEVELOPMENT](https://img.shields.io/badge/UNDER%20DEVELOPMENT-critical?style=for-the-badge&logo=github)](https://github.com/napolitano/performer-nx)

## IMPORTANT — Development status ⚠️

> **WARNING — Experimental software. Use at your own risk.**
>
> This fork is under active development and is not yet considered stable for use in critical environments (for example, live performance). The included tests help catch obvious regressions, but they do not replace long-term validation on actual hardware. Expect breaking changes and incomplete features.

<details>
<summary><strong>More about this warning</strong></summary>

This repository is a development fork intended for contributors and early adopters. Key points:

- Unit and integration tests are present and expanding, but coverage does not guarantee hardware-level stability.
- Official pre-built releases (if published) are validated more thoroughly on the target device and are recommended for production use.
- If you depend on the sequencer for time-critical or safety-sensitive applications (for example live performance), prefer officially released builds or thoroughly test on the actual hardware before use.
...
For deeper implementation details, see the documents in `docs/legacy/performer/`, especially:

- `docs/legacy/performer/DesignDocument.md`
- `docs/legacy/performer/MemoryMap.md`
- `docs/legacy/performer/PinMap.md`
