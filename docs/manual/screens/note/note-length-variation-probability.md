...
# Note Steps — Length Variation Probability

![Note Steps — Length Variation Probability](../../assets/note-length-variation-probability.png)

## Function

Controls how often length variation is applied.
