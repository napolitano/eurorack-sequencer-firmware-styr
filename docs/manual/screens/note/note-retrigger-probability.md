...
# Note Steps — Retrigger Probability

![Note Steps — Retrigger Probability](../../assets/note-retrigger-probability.png)

## Function

Controls how often the configured retrigger is applied.
