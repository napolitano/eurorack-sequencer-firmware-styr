...
# Curve Steps — Gate Probability

![Curve Steps — Gate Probability](../../assets/curve-gate-probability.png)

## Function

Controls how often the configured Curve gate pattern is emitted.
