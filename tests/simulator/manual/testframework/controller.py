...
class Controller:
    ...
    def screenshotScale(self, scale):
        if int(scale) < 1:
            raise ValueError("screenshot scale must be a positive integer")
        self._screenshotScale = int(scale)
        return self
    ...
    def screenshot(self, filename):
        ...
        self._simulator.screenshot(filename, self._screenshotScale)
        return self
