...
Documentation-agent work is maintainer-triggered. Public issues or comments are not treated as authorization to run an agent or modify the manual. An authorized sync issue is assigned once to the **Styr Documentation Orchestrator**, which delegates analysis, authoring, technical review, and final US-English editing to internal specialist agents inside the same task and Draft PR. Deterministic CI and human review remain mandatory. See [`docs/development/documentation/AGENT_WORKFLOW.md`](docs/development/documentation/AGENT_WORKFLOW.md) for the operational workflow and [`docs/development/documentation/README.md`](docs/development/documentation/README.md) for the documentation architecture.
