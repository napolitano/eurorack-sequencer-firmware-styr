/**
 * @file TopPage.cpp
 * @brief Implements the TopPage component used by the sequencer UI page.
 *
...
void TopPage::setSequencePage() {
    ...
    case Track::TrackMode::Lfo:
        // Kein Sequence-View für LFO-Tracks: Fallback auf Overview oder Message
        showMessage("Keine Sequenzansicht für LFO-Tracks verfügbar.");
        break;
...
void TopPage::setSequenceEditPage() {
    auto &pages = _manager.pages();
    auto trackMode = _project.selectedTrack().trackMode();
