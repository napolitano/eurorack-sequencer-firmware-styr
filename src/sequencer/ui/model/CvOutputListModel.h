/**
 * @file CvOutputListModel.h
 * @brief Declares the CvOutputListModel component used by the sequencer UI.
 *
...
/**
 * @brief Provides list data and editing behavior for cv output.
 */
class CvOutputListModel : public ListModel {
public:
    /**
     * @brief Constructs a CvOutputListModel instance.
     *
