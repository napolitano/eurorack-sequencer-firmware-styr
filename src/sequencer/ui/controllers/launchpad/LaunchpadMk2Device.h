/**
 * @file LaunchpadMk2Device.h
 * @brief Declares the LaunchpadMk2Device component used by the sequencer controller.
 *
...
/**
 * @brief Implements protocol and state handling for the launchpad mk2 device.
 */
class LaunchpadMk2Device : public LaunchpadDevice {
public:
    /**
     * @brief Constructs a LaunchpadMk2Device instance.
     */
    LaunchpadMk2Device();
