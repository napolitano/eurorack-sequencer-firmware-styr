/**
 * @file LaunchpadProDevice.h
 * @brief Declares the LaunchpadProDevice component used by the sequencer controller.
 *
...
/**
 * @brief Implements protocol and state handling for the launchpad pro device.
 */
class LaunchpadProDevice : public LaunchpadDevice {
public:
    /**
     * @brief Constructs a LaunchpadProDevice instance.
     */
    LaunchpadProDevice();
