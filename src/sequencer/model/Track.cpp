/**
 * @file Track.cpp
 * @brief Implements the Track component used by the sequencer model.
 *
...
void Track::initContainer() {
    ...
    case TrackMode::MidiCv:
        ...
        break;
    case TrackMode::Lfo:
        _track.lfo = _container.create<LfoTrack>();
        break;
    case TrackMode::Last:
        break;
    }
...
void Track::setContainerTrackIndex(int trackIndex) {
    ...
    case TrackMode::MidiCv:
        ...
        break;
    case TrackMode::Lfo:
        _track.lfo->setTrackIndex(trackIndex);
        break;
    case TrackMode::Last:
        break;
    }
